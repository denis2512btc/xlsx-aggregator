...
# =============================================================================
# Пост-обработка форматирования листов
# =============================================================================

AUTO_WIDTH_TARGET_SHEETS: frozenset[str] = frozenset({"YW2PF", "YQ2PF"})
"""Листы, где после записи применяется подбор ширины колонок по содержимому."""

AUTOFILTER_EXACT_SHEETS: frozenset[str] = frozenset(
    {
        "YYR6PF",
        "YSAPF",
        "YR7PF",
...
"""Листы, где автофильтр включается всегда (если лист существует в книге)."""
